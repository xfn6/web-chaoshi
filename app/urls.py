...
from .view_sets import front_site, message_handler, login_handler, login
...
urlpatterns = [
    ...
    path('', login.indexTest, name='indexTest'),
    path('indexTest1/', login.indexTest1, name='indexTest1'),
    path('loginUsers/', login.loginUsers, name='loginUsers'),
    path('logout/', login.logout, name='logout'),
    path('registerUsers/', login.registerUsers, name='registerUsers'),
    path('user/', login.user_all, name='user'),
    path('user_update/', login.user_update, name='user_update'),
    path('user_delete/', login.user_delete, name='user_delete'),

    path('index/', front_site.index, name='index'),
    ...
    path('personal/', front_site.personal, name='personal'),
